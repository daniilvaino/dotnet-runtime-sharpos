    ...
    CORDB_ADDRESS *              pRemoteContextAddr)
{
    ...
    //
    T_CONTEXT ctx;
// SharpOS port: T_CONTEXT — Win32 _CONTEXT, no XStateFeaturesMask. See dbgtargetcontext.h.
#if !defined(CROSS_COMPILE) && !defined(TARGET_WINDOWS) && !defined(TARGET_SHARPOS) && (defined(DTCONTEXT_IS_AMD64) || defined(DTCONTEXT_IS_ARM64))
