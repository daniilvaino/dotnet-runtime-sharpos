...
if (NOT CLR_CMAKE_HOST_ANDROID AND NOT CLR_CMAKE_TARGET_SHARPOS)
  # SharpOS Phase 6.1 profile per plan.md: "Workstation" GC only.
...
if((CLR_CMAKE_TARGET_ARCH_AMD64 OR CLR_CMAKE_TARGET_ARCH_ARM64 OR CLR_CMAKE_TARGET_ARCH_LOONGARCH64 OR CLR_CMAKE_TARGET_ARCH_RISCV64 OR CLR_CMAKE_TARGET_ARCH_ARM) AND NOT CLR_CMAKE_TARGET_SHARPOS)
  # SharpOS Phase 6.1 profile per plan.md: "non-concurrent" GC. Software write-watch
  # machinery exists for concurrent/background GC tracking; not required in 6.1
  # profile (revisit at 6.2 when concurrent GC + scheduler land).
